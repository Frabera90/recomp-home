...
export const componentRegistry = [
  ...
  },
  {
    ...
    family: "System Tools",
    name: "Refraction / Glass Experiments",
    status: "demoted",
    favorite: false,
    description: "Secondary material exploration for glass behavior on different backgrounds.",
    variants: backgrounds,
    states: glassStates,
    tokens: ["glass", "blur", "opacity", "reflection", "fallback"],
    accessibility: ["contrast", "reduced transparency", "performance budget"],
  },
  {
